...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="@Url.Action("Index", "Cliente", New With {.Area = "Cadastro"})"><i class="glyphicon glyphicon-edit"></i> @ViewContext.RouteData.DataTokens["area"]</a></li>
        <li><a href="@Url.Action("Index", "Cliente", New With {.Area = "Cadastro"})"><i class="fa fa-user"></i> @ViewContext.RouteData.GetRequiredString("controller")</a></li>
...
<section class="content container-fluid">
    <div class="col-12">
        @Using (Html.BeginForm(action, "Cliente", New With {.Area = "Cadastro"}, FormMethod.Post, New With {.class = "form-customer", .enctype = "multipart/form-data"}))
