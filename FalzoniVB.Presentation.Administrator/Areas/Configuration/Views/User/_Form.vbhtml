@ModelType FalzoniVB.Presentation.Administrator.Models.Configuration.UserModel
@Code
    ...
    If ViewData("Perfis") IsNot Nothing Then
        Dim list = CType(ViewData("Perfis"), List(Of FalzoniVB.Presentation.Administrator.Models.Configuration.RoleModel))
